...
public class ArrayAllocationAndInitialization {
	...
	public static boolean[] allocateAndInitialize(boolean[] array, int n, boolean defaultValue){
		array = new boolean[n];
		for (int i = 0; i < n; i++) {
	...
	public static boolean[][] allocateAndInitialize(boolean[][] array, int n1, int n2, boolean defaultValue){
		array = new boolean[n1][n2];
		for (int i = 0; i < n1; i++) {
			for (int j = 0; j < n2; j++) {
